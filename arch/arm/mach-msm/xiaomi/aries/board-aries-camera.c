...
static struct i2c_board_info apq8064_xiaomi_camera_i2c_boardinfo[] = {
	{
...
/* Enabling flash LED for camera */
struct msm_camera_board_info apq8064_xiaomi_camera_board_info = {
	.board_info = apq8064_xiaomi_camera_i2c_boardinfo,
	.num_i2c_board_info = ARRAY_SIZE(apq8064_xiaomi_camera_i2c_boardinfo),
};
